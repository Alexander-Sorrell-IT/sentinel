...
SLIDES: dict[str, list[str]] = {
    ...
    "PHASE1": [
        ...
        "",
        f"  {BOLD}claude-sonnet-4-6{RESET} is acting as the attacker.",
        f"  It reads the agent's policy and invents attack probes.",
        "",
        f"  Policy under test:",
        ...
        "",
        f"  The agent runs {RED}unguarded{RESET}.",
        f"  Every attack that succeeds here would execute",
        f"  {RED}in production{RESET} without Sentinel.",
        "",
        f"  {DIM}Watch the score...{RESET}",
    ],
